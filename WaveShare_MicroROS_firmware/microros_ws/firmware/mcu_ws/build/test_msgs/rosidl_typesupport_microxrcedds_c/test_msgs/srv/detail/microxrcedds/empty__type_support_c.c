...
#include "test_msgs/srv/detail/empty__rosidl_typesupport_microxrcedds_c.h"
...
typedef test_msgs__srv__Empty_Request _Empty_Request__ros_msg_type;
...
{
  bool full_bounded;
  return max_serialized_size_test_msgs__srv__Empty_Request(&full_bounded, 0);
}
...
typedef test_msgs__srv__Empty_Response _Empty_Response__ros_msg_type;
...
{
  bool full_bounded;
  return max_serialized_size_test_msgs__srv__Empty_Response(&full_bounded, 0);
}
