...
#include "test_msgs/msg/detail/unbounded_sequences__rosidl_typesupport_microxrcedds_c.h"
...
typedef test_msgs__msg__UnboundedSequences _UnboundedSequences__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _UnboundedSequences__ros_msg_type * ros_message = (_UnboundedSequences__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  // Member: string_values
  {
    ...
    for (size_t i = 0; rv && i < size; ++i) {
      rv = ucdr_serialize_string(cdr, ros_message->string_values.data[i].data);
    }
  }
  ...
  // Member: string_values_default
  {
    ...
    rv = ucdr_serialize_uint32_t(cdr, size);
    for (size_t i = 0; rv && i < size; ++i) {
      rv = ucdr_serialize_string(cdr, ros_message->string_values_default.data[i].data);
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: string_values
  {
    ...
    for (size_t i = 0; rv && i < size; i++) {
      ...
      if (rv) {
        ros_message->string_values.data[i].size = strlen(data);
      }
    }
  }
  ...
  // Field name: string_values_default
  {
    ...
    for (size_t i = 0; rv && i < size; i++) {
      ...
      rv = ucdr_deserialize_string(cdr, data, capacity);
      if (rv) {
        ros_message->string_values_default.data[i].size = strlen(data);
      }
    }
  }
  ...
  size_t current_alignment)
{
  ...
  const _UnboundedSequences__ros_msg_type * ros_message = (const _UnboundedSequences__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  // Member: basic_types_values
  {
    ...
    for(size_t i = 0; i < sequence_size; i++){
      size_t element_size = ((const message_type_support_callbacks_t *)(
        ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, test_msgs, msg, BasicTypes
        )()->data))->get_serialized_size(&ros_message->basic_types_values.data[i]);
  ...
  // Member: constants_values
  {
    ...
    for(size_t i = 0; i < sequence_size; i++){
      size_t element_size = ((const message_type_support_callbacks_t *)(
        ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, test_msgs, msg, Constants
        )()->data))->get_serialized_size(&ros_message->constants_values.data[i]);
      uint8_t alignment_size = (element_size < MICROXRCEDDS_PADDING) ? element_size : MICROXRCEDDS_PADDING;
      current_alignment += ucdr_alignment(current_alignment, alignment_size) + element_size;
    }
  }
  // Member: defaults_values
  {
    ...
    for(size_t i = 0; i < sequence_size; i++){
      size_t element_size = ((const message_type_support_callbacks_t *)(
        ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, test_msgs, msg, Defaults
        )()->data))->get_serialized_size(&ros_message->defaults_values.data[i]);
      uint8_t alignment_size = (element_size < MICROXRCEDDS_PADDING) ? element_size : MICROXRCEDDS_PADDING;
      current_alignment += ucdr_alignment(current_alignment, alignment_size) + element_size;
    }
  }
...
{
  bool full_bounded;
  return max_serialized_size_test_msgs__msg__UnboundedSequences(&full_bounded, 0);
}
