...
#include "geometry_msgs/msg/detail/twist__rosidl_typesupport_microxrcedds_c.h"
...
typedef geometry_msgs__msg__Twist _Twist__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _Twist__ros_msg_type * ros_message = (_Twist__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _Twist__ros_msg_type * ros_message = (const _Twist__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _Twist__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_geometry_msgs__msg__Twist(&full_bounded, 0);
}
