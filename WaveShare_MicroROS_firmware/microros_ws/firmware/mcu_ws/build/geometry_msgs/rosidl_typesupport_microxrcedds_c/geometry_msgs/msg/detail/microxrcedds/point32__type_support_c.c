...
#include "geometry_msgs/msg/detail/point32__rosidl_typesupport_microxrcedds_c.h"
...
typedef geometry_msgs__msg__Point32 _Point32__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _Point32__ros_msg_type * ros_message = (_Point32__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _Point32__ros_msg_type * ros_message = (const _Point32__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
{
  bool full_bounded;
  return max_serialized_size_geometry_msgs__msg__Point32(&full_bounded, 0);
}
