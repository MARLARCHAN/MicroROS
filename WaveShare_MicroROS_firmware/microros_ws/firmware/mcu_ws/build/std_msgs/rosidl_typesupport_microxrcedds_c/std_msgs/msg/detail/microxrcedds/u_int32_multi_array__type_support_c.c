...
#include "std_msgs/msg/detail/u_int32_multi_array__rosidl_typesupport_microxrcedds_c.h"
...
typedef std_msgs__msg__UInt32MultiArray _UInt32MultiArray__ros_msg_type;
...
{
  bool full_bounded;
  return max_serialized_size_std_msgs__msg__UInt32MultiArray(&full_bounded, 0);
}
