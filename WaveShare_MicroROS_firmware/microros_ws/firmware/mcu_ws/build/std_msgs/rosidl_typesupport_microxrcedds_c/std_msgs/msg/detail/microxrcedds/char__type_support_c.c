...
#include "std_msgs/msg/detail/char__rosidl_typesupport_microxrcedds_c.h"
...
typedef std_msgs__msg__Char _Char__ros_msg_type;
...
{
  bool full_bounded;
  return max_serialized_size_std_msgs__msg__Char(&full_bounded, 0);
}
