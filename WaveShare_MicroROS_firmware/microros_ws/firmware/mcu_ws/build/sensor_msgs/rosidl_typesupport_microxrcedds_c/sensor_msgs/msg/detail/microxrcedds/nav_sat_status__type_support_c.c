...
#include "sensor_msgs/msg/detail/nav_sat_status__rosidl_typesupport_microxrcedds_c.h"
...
typedef sensor_msgs__msg__NavSatStatus _NavSatStatus__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _NavSatStatus__ros_msg_type * ros_message = (_NavSatStatus__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _NavSatStatus__ros_msg_type * ros_message = (const _NavSatStatus__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
{
  bool full_bounded;
  return max_serialized_size_sensor_msgs__msg__NavSatStatus(&full_bounded, 0);
}
