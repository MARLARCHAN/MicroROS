...
#include "nav_msgs/msg/detail/path__rosidl_typesupport_microxrcedds_c.h"
...
typedef nav_msgs__msg__Path _Path__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _Path__ros_msg_type * ros_message = (_Path__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _Path__ros_msg_type * ros_message = (const _Path__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
{
  bool full_bounded;
  return max_serialized_size_nav_msgs__msg__Path(&full_bounded, 0);
}
