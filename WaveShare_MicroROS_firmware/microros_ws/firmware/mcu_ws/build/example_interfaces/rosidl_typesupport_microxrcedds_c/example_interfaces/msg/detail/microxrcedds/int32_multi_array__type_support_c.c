...
#include "example_interfaces/msg/detail/int32_multi_array__rosidl_typesupport_microxrcedds_c.h"
...
typedef example_interfaces__msg__Int32MultiArray _Int32MultiArray__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _Int32MultiArray__ros_msg_type * ros_message = (_Int32MultiArray__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  // Member: data
  {
    ...
    rv = ucdr_serialize_sequence_int32_t(cdr, ros_message->data.data, size);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: data
  {
    ...
    rv = ucdr_deserialize_sequence_int32_t(cdr, ros_message->data.data, capacity, &size);
  ...
  size_t current_alignment)
{
  ...
  const _Int32MultiArray__ros_msg_type * ros_message = (const _Int32MultiArray__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _Int32MultiArray__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_example_interfaces__msg__Int32MultiArray(&full_bounded, 0);
}
