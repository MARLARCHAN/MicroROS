  ...
  ucdrBuffer * cdr)
{
  ...
  // Member: description
  rv = ucdr_serialize_string(cdr, ros_message->description.data);
  if (rv) {
    ros_message->description.size = strlen(ros_message->description.data);
  }
  // Member: additional_constraints
  rv = ucdr_serialize_string(cdr, ros_message->additional_constraints.data);
  if (rv) {
    ros_message->additional_constraints.size = strlen(ros_message->additional_constraints.data);
  }
  // Member: read_only
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: description
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->description.data, capacity);
    if (rv) {
      ros_message->description.size = strlen(ros_message->description.data);
    }
  }
  // Field name: additional_constraints
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->additional_constraints.data, capacity);
    if (rv) {
      ros_message->additional_constraints.size = strlen(ros_message->additional_constraints.data);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: floating_point_range
  {
    ...
    for(size_t i = 0; i < sequence_size; i++){
      size_t element_size = ((const message_type_support_callbacks_t *)(
        ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, rcl_interfaces, msg, FloatingPointRange
        )()->data))->get_serialized_size(&ros_message->floating_point_range.data[i]);
  ...
  // Member: integer_range
  {
    ...
    for(size_t i = 0; i < sequence_size; i++){
      size_t element_size = ((const message_type_support_callbacks_t *)(
        ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, rcl_interfaces, msg, IntegerRange
        )()->data))->get_serialized_size(&ros_message->integer_range.data[i]);
      uint8_t alignment_size = (element_size < MICROXRCEDDS_PADDING) ? element_size : MICROXRCEDDS_PADDING;
      current_alignment += ucdr_alignment(current_alignment, alignment_size) + element_size;
    }
  }
