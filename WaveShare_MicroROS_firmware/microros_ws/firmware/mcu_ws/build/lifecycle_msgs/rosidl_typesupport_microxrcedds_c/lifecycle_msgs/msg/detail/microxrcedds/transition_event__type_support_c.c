...
#include "lifecycle_msgs/msg/detail/transition_event__rosidl_typesupport_microxrcedds_c.h"
...
typedef lifecycle_msgs__msg__TransitionEvent _TransitionEvent__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _TransitionEvent__ros_msg_type * ros_message = (_TransitionEvent__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _TransitionEvent__ros_msg_type * ros_message = (const _TransitionEvent__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
{
  bool full_bounded;
  return max_serialized_size_lifecycle_msgs__msg__TransitionEvent(&full_bounded, 0);
}
