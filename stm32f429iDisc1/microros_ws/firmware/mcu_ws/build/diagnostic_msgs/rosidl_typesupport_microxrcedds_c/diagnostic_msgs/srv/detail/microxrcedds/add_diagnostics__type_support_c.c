  ...
  ucdrBuffer * cdr)
{
  ...
  rv = ucdr_serialize_string(cdr, ros_message->load_namespace.data);
  if (rv) {
    ros_message->load_namespace.size = strlen(ros_message->load_namespace.data);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: load_namespace
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->load_namespace.data, capacity);
    if (rv) {
      ros_message->load_namespace.size = strlen(ros_message->load_namespace.data);
    }
  }
