  ...
  ucdrBuffer * cdr)
{
  ...
  // Member: key
  rv = ucdr_serialize_string(cdr, ros_message->key.data);
  if (rv) {
    ros_message->key.size = strlen(ros_message->key.data);
  }
  // Member: value
  rv = ucdr_serialize_string(cdr, ros_message->value.data);
  if (rv) {
    ros_message->value.size = strlen(ros_message->value.data);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: key
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->key.data, capacity);
    if (rv) {
      ros_message->key.size = strlen(ros_message->key.data);
    }
  }
  // Field name: value
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->value.data, capacity);
    if (rv) {
      ros_message->value.size = strlen(ros_message->value.data);
    }
  }
