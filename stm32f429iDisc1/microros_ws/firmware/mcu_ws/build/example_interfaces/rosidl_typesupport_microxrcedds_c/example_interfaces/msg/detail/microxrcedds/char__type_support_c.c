...
#include "example_interfaces/msg/detail/char__rosidl_typesupport_microxrcedds_c.h"
...
typedef example_interfaces__msg__Char _Char__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _Char__ros_msg_type * ros_message = (_Char__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _Char__ros_msg_type * ros_message = (const _Char__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _Char__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_example_interfaces__msg__Char(&full_bounded, 0);
}
