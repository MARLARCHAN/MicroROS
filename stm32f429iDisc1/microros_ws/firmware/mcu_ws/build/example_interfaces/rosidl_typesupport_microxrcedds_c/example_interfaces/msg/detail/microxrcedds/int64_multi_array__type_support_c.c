...
#include "example_interfaces/msg/detail/int64_multi_array__rosidl_typesupport_microxrcedds_c.h"
...
typedef example_interfaces__msg__Int64MultiArray _Int64MultiArray__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _Int64MultiArray__ros_msg_type * ros_message = (_Int64MultiArray__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  // Member: data
  {
    ...
    rv = ucdr_serialize_sequence_int64_t(cdr, ros_message->data.data, size);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: data
  {
    ...
    rv = ucdr_deserialize_sequence_int64_t(cdr, ros_message->data.data, capacity, &size);
  ...
  size_t current_alignment)
{
  ...
  const _Int64MultiArray__ros_msg_type * ros_message = (const _Int64MultiArray__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _Int64MultiArray__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_example_interfaces__msg__Int64MultiArray(&full_bounded, 0);
}
