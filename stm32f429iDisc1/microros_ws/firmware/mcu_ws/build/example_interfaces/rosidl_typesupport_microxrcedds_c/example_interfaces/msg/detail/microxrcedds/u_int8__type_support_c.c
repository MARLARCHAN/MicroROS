...
#include "example_interfaces/msg/detail/u_int8__rosidl_typesupport_microxrcedds_c.h"
...
typedef example_interfaces__msg__UInt8 _UInt8__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _UInt8__ros_msg_type * ros_message = (_UInt8__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _UInt8__ros_msg_type * ros_message = (const _UInt8__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _UInt8__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_example_interfaces__msg__UInt8(&full_bounded, 0);
}
