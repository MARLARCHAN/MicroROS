...
#include "example_interfaces/msg/detail/float64_multi_array__rosidl_typesupport_microxrcedds_c.h"
...
typedef example_interfaces__msg__Float64MultiArray _Float64MultiArray__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _Float64MultiArray__ros_msg_type * ros_message = (_Float64MultiArray__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  // Member: data
  {
    ...
    rv = ucdr_serialize_sequence_double(cdr, ros_message->data.data, size);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: data
  {
    ...
    rv = ucdr_deserialize_sequence_double(cdr, ros_message->data.data, capacity, &size);
  ...
  size_t current_alignment)
{
  ...
  const _Float64MultiArray__ros_msg_type * ros_message = (const _Float64MultiArray__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _Float64MultiArray__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_example_interfaces__msg__Float64MultiArray(&full_bounded, 0);
}
