  ...
  ucdrBuffer * cdr)
{
  ...
  rv = ucdr_serialize_string(cdr, ros_message->status_message.data);
  if (rv) {
    ros_message->status_message.size = strlen(ros_message->status_message.data);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: status_message
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->status_message.data, capacity);
    if (rv) {
      ros_message->status_message.size = strlen(ros_message->status_message.data);
    }
  }
