  ...
  ucdrBuffer * cdr)
{
  ...
  // Member: client_id
  rv = ucdr_serialize_string(cdr, ros_message->client_id.data);
  if (rv) {
    ros_message->client_id.size = strlen(ros_message->client_id.data);
  }
  // Member: marker_name
  rv = ucdr_serialize_string(cdr, ros_message->marker_name.data);
  if (rv) {
    ros_message->marker_name.size = strlen(ros_message->marker_name.data);
  }
  // Member: control_name
  rv = ucdr_serialize_string(cdr, ros_message->control_name.data);
  if (rv) {
    ros_message->control_name.size = strlen(ros_message->control_name.data);
  }
  // Member: event_type
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: client_id
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->client_id.data, capacity);
    if (rv) {
      ros_message->client_id.size = strlen(ros_message->client_id.data);
    }
  }
  // Field name: marker_name
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->marker_name.data, capacity);
    if (rv) {
      ros_message->marker_name.size = strlen(ros_message->marker_name.data);
    }
  }
  // Field name: control_name
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->control_name.data, capacity);
    if (rv) {
      ros_message->control_name.size = strlen(ros_message->control_name.data);
    }
  }
