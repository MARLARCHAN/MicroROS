...
set(_exported_libraries "drive_base_msgs__rosidl_generator_c;drive_base_msgs__rosidl_typesupport_c")
...
if(NOT _exported_library_names STREQUAL "")
  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING "Package 'drive_base_msgs' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND drive_base_msgs_LIBRARIES ${_cfg} "${_lib}")
