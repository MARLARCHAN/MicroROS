  ...
  ucdrBuffer * cdr)
{
  ...
  // Member: node
  rv = ucdr_serialize_string(cdr, ros_message->node.data);
  if (rv) {
    ros_message->node.size = strlen(ros_message->node.data);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: node
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->node.data, capacity);
    if (rv) {
      ros_message->node.size = strlen(ros_message->node.data);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: new_parameters
  {
    ...
    for(size_t i = 0; i < sequence_size; i++){
      size_t element_size = ((const message_type_support_callbacks_t *)(
        ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, rcl_interfaces, msg, Parameter
        )()->data))->get_serialized_size(&ros_message->new_parameters.data[i]);
  ...
  // Member: changed_parameters
  {
    ...
    for(size_t i = 0; i < sequence_size; i++){
      size_t element_size = ((const message_type_support_callbacks_t *)(
        ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, rcl_interfaces, msg, Parameter
        )()->data))->get_serialized_size(&ros_message->changed_parameters.data[i]);
      uint8_t alignment_size = (element_size < MICROXRCEDDS_PADDING) ? element_size : MICROXRCEDDS_PADDING;
      current_alignment += ucdr_alignment(current_alignment, alignment_size) + element_size;
    }
  }
  // Member: deleted_parameters
  {
    ...
    for(size_t i = 0; i < sequence_size; i++){
      size_t element_size = ((const message_type_support_callbacks_t *)(
        ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, rcl_interfaces, msg, Parameter
        )()->data))->get_serialized_size(&ros_message->deleted_parameters.data[i]);
      uint8_t alignment_size = (element_size < MICROXRCEDDS_PADDING) ? element_size : MICROXRCEDDS_PADDING;
      current_alignment += ucdr_alignment(current_alignment, alignment_size) + element_size;
    }
  }
