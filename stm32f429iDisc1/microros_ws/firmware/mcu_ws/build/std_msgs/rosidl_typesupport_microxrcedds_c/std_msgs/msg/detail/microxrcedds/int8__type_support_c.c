...
#include "std_msgs/msg/detail/int8__rosidl_typesupport_microxrcedds_c.h"
...
typedef std_msgs__msg__Int8 _Int8__ros_msg_type;
...
{
  bool full_bounded;
  return max_serialized_size_std_msgs__msg__Int8(&full_bounded, 0);
}
