...
#include "std_msgs/msg/detail/multi_array_layout__rosidl_typesupport_microxrcedds_c.h"
...
typedef std_msgs__msg__MultiArrayLayout _MultiArrayLayout__ros_msg_type;
  ...
  // Member: dim
  {
    ...
    for(size_t i = 0; i < sequence_size; i++){
      size_t element_size = ((const message_type_support_callbacks_t *)(
        ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, std_msgs, msg, MultiArrayDimension
        )()->data))->get_serialized_size(&ros_message->dim.data[i]);
...
{
  bool full_bounded;
  return max_serialized_size_std_msgs__msg__MultiArrayLayout(&full_bounded, 0);
}
