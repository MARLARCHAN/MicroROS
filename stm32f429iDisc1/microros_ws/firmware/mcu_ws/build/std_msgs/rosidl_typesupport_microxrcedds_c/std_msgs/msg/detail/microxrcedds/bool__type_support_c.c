...
#include "std_msgs/msg/detail/bool__rosidl_typesupport_microxrcedds_c.h"
...
typedef std_msgs__msg__Bool _Bool__ros_msg_type;
...
{
  bool full_bounded;
  return max_serialized_size_std_msgs__msg__Bool(&full_bounded, 0);
}
