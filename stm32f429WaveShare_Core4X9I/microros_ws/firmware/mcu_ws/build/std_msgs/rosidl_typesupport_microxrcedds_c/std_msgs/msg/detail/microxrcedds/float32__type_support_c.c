...
#include "std_msgs/msg/detail/float32__rosidl_typesupport_microxrcedds_c.h"
...
typedef std_msgs__msg__Float32 _Float32__ros_msg_type;
...
{
  bool full_bounded;
  return max_serialized_size_std_msgs__msg__Float32(&full_bounded, 0);
}
