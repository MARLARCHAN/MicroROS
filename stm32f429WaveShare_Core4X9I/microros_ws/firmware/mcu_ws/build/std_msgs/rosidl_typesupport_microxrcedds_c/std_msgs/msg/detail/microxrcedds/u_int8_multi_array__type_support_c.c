...
#include "std_msgs/msg/detail/u_int8_multi_array__rosidl_typesupport_microxrcedds_c.h"
...
typedef std_msgs__msg__UInt8MultiArray _UInt8MultiArray__ros_msg_type;
...
{
  bool full_bounded;
  return max_serialized_size_std_msgs__msg__UInt8MultiArray(&full_bounded, 0);
}
