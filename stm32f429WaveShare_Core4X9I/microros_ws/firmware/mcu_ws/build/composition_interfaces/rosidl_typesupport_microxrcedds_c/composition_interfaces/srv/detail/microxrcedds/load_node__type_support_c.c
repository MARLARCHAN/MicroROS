  ...
  ucdrBuffer * cdr)
{
  ...
  // Member: package_name
  rv = ucdr_serialize_string(cdr, ros_message->package_name.data);
  if (rv) {
    ros_message->package_name.size = strlen(ros_message->package_name.data);
  }
  // Member: plugin_name
  rv = ucdr_serialize_string(cdr, ros_message->plugin_name.data);
  if (rv) {
    ros_message->plugin_name.size = strlen(ros_message->plugin_name.data);
  }
  // Member: node_name
  rv = ucdr_serialize_string(cdr, ros_message->node_name.data);
  if (rv) {
    ros_message->node_name.size = strlen(ros_message->node_name.data);
  }
  // Member: node_namespace
  rv = ucdr_serialize_string(cdr, ros_message->node_namespace.data);
  if (rv) {
    ros_message->node_namespace.size = strlen(ros_message->node_namespace.data);
  }
  // Member: log_level
  ...
  // Member: remap_rules
  {
    ...
    for (size_t i = 0; rv && i < size; ++i) {
      rv = ucdr_serialize_string(cdr, ros_message->remap_rules.data[i].data);
    }
  }
  // Member: parameters
  {
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: package_name
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->package_name.data, capacity);
    if (rv) {
      ros_message->package_name.size = strlen(ros_message->package_name.data);
    }
  }
  // Field name: plugin_name
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->plugin_name.data, capacity);
    if (rv) {
      ros_message->plugin_name.size = strlen(ros_message->plugin_name.data);
    }
  }
  // Field name: node_name
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->node_name.data, capacity);
    if (rv) {
      ros_message->node_name.size = strlen(ros_message->node_name.data);
    }
  }
  // Field name: node_namespace
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->node_namespace.data, capacity);
    if (rv) {
      ros_message->node_namespace.size = strlen(ros_message->node_namespace.data);
    }
  }
  ...
  // Field name: remap_rules
  {
    ...
    for (size_t i = 0; rv && i < size; i++) {
      ...
      if (rv) {
        ros_message->remap_rules.data[i].size = strlen(data);
      }
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: parameters
  {
    ...
    for(size_t i = 0; i < sequence_size; i++){
      size_t element_size = ((const message_type_support_callbacks_t *)(
        ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, rcl_interfaces, msg, Parameter
        )()->data))->get_serialized_size(&ros_message->parameters.data[i]);
  ...
  // Member: extra_arguments
  {
    ...
    for(size_t i = 0; i < sequence_size; i++){
      size_t element_size = ((const message_type_support_callbacks_t *)(
        ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, rcl_interfaces, msg, Parameter
        )()->data))->get_serialized_size(&ros_message->extra_arguments.data[i]);
      uint8_t alignment_size = (element_size < MICROXRCEDDS_PADDING) ? element_size : MICROXRCEDDS_PADDING;
      current_alignment += ucdr_alignment(current_alignment, alignment_size) + element_size;
    }
  }
  ...
  ucdrBuffer * cdr)
{
  ...
  rv = ucdr_serialize_string(cdr, ros_message->error_message.data);
  if (rv) {
    ros_message->error_message.size = strlen(ros_message->error_message.data);
  }
  // Member: full_node_name
  rv = ucdr_serialize_string(cdr, ros_message->full_node_name.data);
  if (rv) {
    ros_message->full_node_name.size = strlen(ros_message->full_node_name.data);
  }
  // Member: unique_id
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: error_message
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->error_message.data, capacity);
    if (rv) {
      ros_message->error_message.size = strlen(ros_message->error_message.data);
    }
  }
  // Field name: full_node_name
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->full_node_name.data, capacity);
    if (rv) {
      ros_message->full_node_name.size = strlen(ros_message->full_node_name.data);
    }
  }
