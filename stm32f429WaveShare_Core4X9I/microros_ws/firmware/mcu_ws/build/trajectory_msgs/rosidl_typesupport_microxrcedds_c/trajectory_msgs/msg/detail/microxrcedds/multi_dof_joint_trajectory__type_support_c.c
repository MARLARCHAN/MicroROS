...
#include "trajectory_msgs/msg/detail/multi_dof_joint_trajectory__rosidl_typesupport_microxrcedds_c.h"
...
typedef trajectory_msgs__msg__MultiDOFJointTrajectory _MultiDOFJointTrajectory__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _MultiDOFJointTrajectory__ros_msg_type * ros_message = (_MultiDOFJointTrajectory__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  // Member: joint_names
  {
    ...
    for (size_t i = 0; rv && i < size; ++i) {
      rv = ucdr_serialize_string(cdr, ros_message->joint_names.data[i].data);
    }
  }
  // Member: points
  {
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: joint_names
  {
    ...
    for (size_t i = 0; rv && i < size; i++) {
      ...
      if (rv) {
        ros_message->joint_names.data[i].size = strlen(data);
      }
    }
  }
  // Field name: points
  ...
  size_t current_alignment)
{
  ...
  const _MultiDOFJointTrajectory__ros_msg_type * ros_message = (const _MultiDOFJointTrajectory__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _MultiDOFJointTrajectory__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_trajectory_msgs__msg__MultiDOFJointTrajectory(&full_bounded, 0);
}
