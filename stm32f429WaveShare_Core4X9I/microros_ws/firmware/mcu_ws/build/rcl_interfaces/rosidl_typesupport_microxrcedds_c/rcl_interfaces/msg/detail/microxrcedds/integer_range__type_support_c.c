...
#include "rcl_interfaces/msg/detail/integer_range__rosidl_typesupport_microxrcedds_c.h"
...
typedef rcl_interfaces__msg__IntegerRange _IntegerRange__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _IntegerRange__ros_msg_type * ros_message = (_IntegerRange__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _IntegerRange__ros_msg_type * ros_message = (const _IntegerRange__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
{
  bool full_bounded;
  return max_serialized_size_rcl_interfaces__msg__IntegerRange(&full_bounded, 0);
}
