  ...
  ucdrBuffer * cdr)
{
  ...
  rv = ucdr_serialize_string(cdr, ros_message->string_value_default1.data);
  if (rv) {
    ros_message->string_value_default1.size = strlen(ros_message->string_value_default1.data);
  }
  // Member: string_value_default2
  rv = ucdr_serialize_string(cdr, ros_message->string_value_default2.data);
  if (rv) {
    ros_message->string_value_default2.size = strlen(ros_message->string_value_default2.data);
  }
  // Member: string_value_default3
  rv = ucdr_serialize_string(cdr, ros_message->string_value_default3.data);
  if (rv) {
    ros_message->string_value_default3.size = strlen(ros_message->string_value_default3.data);
  }
  // Member: string_value_default4
  rv = ucdr_serialize_string(cdr, ros_message->string_value_default4.data);
  if (rv) {
    ros_message->string_value_default4.size = strlen(ros_message->string_value_default4.data);
  }
  // Member: string_value_default5
  rv = ucdr_serialize_string(cdr, ros_message->string_value_default5.data);
  if (rv) {
    ros_message->string_value_default5.size = strlen(ros_message->string_value_default5.data);
  }
  // Member: bounded_string_value
  rv = ucdr_serialize_string(cdr, ros_message->bounded_string_value.data);
  if (rv) {
    ros_message->bounded_string_value.size = strlen(ros_message->bounded_string_value.data);
  }
  // Member: bounded_string_value_default1
  rv = ucdr_serialize_string(cdr, ros_message->bounded_string_value_default1.data);
  if (rv) {
    ros_message->bounded_string_value_default1.size = strlen(ros_message->bounded_string_value_default1.data);
  }
  // Member: bounded_string_value_default2
  rv = ucdr_serialize_string(cdr, ros_message->bounded_string_value_default2.data);
  if (rv) {
    ros_message->bounded_string_value_default2.size = strlen(ros_message->bounded_string_value_default2.data);
  }
  // Member: bounded_string_value_default3
  rv = ucdr_serialize_string(cdr, ros_message->bounded_string_value_default3.data);
  if (rv) {
    ros_message->bounded_string_value_default3.size = strlen(ros_message->bounded_string_value_default3.data);
  }
  // Member: bounded_string_value_default4
  rv = ucdr_serialize_string(cdr, ros_message->bounded_string_value_default4.data);
  if (rv) {
    ros_message->bounded_string_value_default4.size = strlen(ros_message->bounded_string_value_default4.data);
  }
  // Member: bounded_string_value_default5
  rv = ucdr_serialize_string(cdr, ros_message->bounded_string_value_default5.data);
  if (rv) {
    ros_message->bounded_string_value_default5.size = strlen(ros_message->bounded_string_value_default5.data);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: string_value_default1
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->string_value_default1.data, capacity);
    if (rv) {
      ros_message->string_value_default1.size = strlen(ros_message->string_value_default1.data);
    }
  }
  // Field name: string_value_default2
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->string_value_default2.data, capacity);
    if (rv) {
      ros_message->string_value_default2.size = strlen(ros_message->string_value_default2.data);
    }
  }
  // Field name: string_value_default3
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->string_value_default3.data, capacity);
    if (rv) {
      ros_message->string_value_default3.size = strlen(ros_message->string_value_default3.data);
    }
  }
  // Field name: string_value_default4
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->string_value_default4.data, capacity);
    if (rv) {
      ros_message->string_value_default4.size = strlen(ros_message->string_value_default4.data);
    }
  }
  // Field name: string_value_default5
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->string_value_default5.data, capacity);
    if (rv) {
      ros_message->string_value_default5.size = strlen(ros_message->string_value_default5.data);
    }
  }
  // Field name: bounded_string_value
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->bounded_string_value.data, capacity);
    if (rv) {
      ros_message->bounded_string_value.size = strlen(ros_message->bounded_string_value.data);
    }
  }
  // Field name: bounded_string_value_default1
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->bounded_string_value_default1.data, capacity);
    if (rv) {
      ros_message->bounded_string_value_default1.size = strlen(ros_message->bounded_string_value_default1.data);
    }
  }
  // Field name: bounded_string_value_default2
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->bounded_string_value_default2.data, capacity);
    if (rv) {
      ros_message->bounded_string_value_default2.size = strlen(ros_message->bounded_string_value_default2.data);
    }
  }
  // Field name: bounded_string_value_default3
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->bounded_string_value_default3.data, capacity);
    if (rv) {
      ros_message->bounded_string_value_default3.size = strlen(ros_message->bounded_string_value_default3.data);
    }
  }
  // Field name: bounded_string_value_default4
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->bounded_string_value_default4.data, capacity);
    if (rv) {
      ros_message->bounded_string_value_default4.size = strlen(ros_message->bounded_string_value_default4.data);
    }
  }
  // Field name: bounded_string_value_default5
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->bounded_string_value_default5.data, capacity);
    if (rv) {
      ros_message->bounded_string_value_default5.size = strlen(ros_message->bounded_string_value_default5.data);
    }
  }
