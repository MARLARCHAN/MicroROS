...
#include "test_msgs/msg/detail/basic_types__rosidl_typesupport_microxrcedds_c.h"
...
typedef test_msgs__msg__BasicTypes _BasicTypes__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _BasicTypes__ros_msg_type * ros_message = (_BasicTypes__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _BasicTypes__ros_msg_type * ros_message = (const _BasicTypes__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _BasicTypes__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_test_msgs__msg__BasicTypes(&full_bounded, 0);
}
