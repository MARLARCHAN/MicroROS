...
#include "example_interfaces/msg/detail/u_int64__rosidl_typesupport_microxrcedds_c.h"
...
typedef example_interfaces__msg__UInt64 _UInt64__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _UInt64__ros_msg_type * ros_message = (_UInt64__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;

  // Member: data
  rv = ucdr_serialize_uint64_t(cdr, ros_message->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: data
  rv = ucdr_deserialize_uint64_t(cdr, &ros_message->data);
  return rv;
}
  ...
  size_t current_alignment)
{
  ...
  const _UInt64__ros_msg_type * ros_message = (const _UInt64__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _UInt64__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_example_interfaces__msg__UInt64(&full_bounded, 0);
}
