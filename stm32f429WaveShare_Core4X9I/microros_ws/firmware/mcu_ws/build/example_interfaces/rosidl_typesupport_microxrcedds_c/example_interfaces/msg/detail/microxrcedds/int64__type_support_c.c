...
#include "example_interfaces/msg/detail/int64__rosidl_typesupport_microxrcedds_c.h"
...
typedef example_interfaces__msg__Int64 _Int64__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _Int64__ros_msg_type * ros_message = (_Int64__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _Int64__ros_msg_type * ros_message = (const _Int64__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
{
  bool full_bounded;
  return max_serialized_size_example_interfaces__msg__Int64(&full_bounded, 0);
}
