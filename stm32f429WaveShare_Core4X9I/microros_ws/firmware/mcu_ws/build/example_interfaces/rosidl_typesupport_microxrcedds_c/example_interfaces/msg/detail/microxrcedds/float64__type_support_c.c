...
#include "example_interfaces/msg/detail/float64__rosidl_typesupport_microxrcedds_c.h"
...
typedef example_interfaces__msg__Float64 _Float64__ros_msg_type;
...
{
  bool full_bounded;
  return max_serialized_size_example_interfaces__msg__Float64(&full_bounded, 0);
}
