...
#include "example_interfaces/msg/detail/u_int32_multi_array__rosidl_typesupport_microxrcedds_c.h"
...
typedef example_interfaces__msg__UInt32MultiArray _UInt32MultiArray__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _UInt32MultiArray__ros_msg_type * ros_message = (_UInt32MultiArray__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _UInt32MultiArray__ros_msg_type * ros_message = (const _UInt32MultiArray__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _UInt32MultiArray__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_example_interfaces__msg__UInt32MultiArray(&full_bounded, 0);
}
