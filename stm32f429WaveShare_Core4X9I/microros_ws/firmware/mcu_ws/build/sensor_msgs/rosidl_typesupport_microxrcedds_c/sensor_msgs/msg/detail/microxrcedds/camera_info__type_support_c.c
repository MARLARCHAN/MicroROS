  ...
  ucdrBuffer * cdr)
{
  ...
  rv = ucdr_serialize_string(cdr, ros_message->distortion_model.data);
  if (rv) {
    ros_message->distortion_model.size = strlen(ros_message->distortion_model.data);
  }
  // Member: d
  {
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: distortion_model
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->distortion_model.data, capacity);
    if (rv) {
      ros_message->distortion_model.size = strlen(ros_message->distortion_model.data);
    }
  }
