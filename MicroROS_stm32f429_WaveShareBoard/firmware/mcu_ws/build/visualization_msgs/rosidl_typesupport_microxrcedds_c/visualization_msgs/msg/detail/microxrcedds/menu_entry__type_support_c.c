  ...
  ucdrBuffer * cdr)
{
  ...
  // Member: title
  rv = ucdr_serialize_string(cdr, ros_message->title.data);
  if (rv) {
    ros_message->title.size = strlen(ros_message->title.data);
  }
  // Member: command
  rv = ucdr_serialize_string(cdr, ros_message->command.data);
  if (rv) {
    ros_message->command.size = strlen(ros_message->command.data);
  }
  // Member: command_type
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: title
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->title.data, capacity);
    if (rv) {
      ros_message->title.size = strlen(ros_message->title.data);
    }
  }
  // Field name: command
  {
    ...
    rv = ucdr_deserialize_string(cdr, ros_message->command.data, capacity);
    if (rv) {
      ros_message->command.size = strlen(ros_message->command.data);
    }
  }
