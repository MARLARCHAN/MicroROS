...
#include "example_interfaces/msg/detail/byte__rosidl_typesupport_microxrcedds_c.h"
...
typedef example_interfaces__msg__Byte _Byte__ros_msg_type;
...
{
  bool full_bounded;
  return max_serialized_size_example_interfaces__msg__Byte(&full_bounded, 0);
}
