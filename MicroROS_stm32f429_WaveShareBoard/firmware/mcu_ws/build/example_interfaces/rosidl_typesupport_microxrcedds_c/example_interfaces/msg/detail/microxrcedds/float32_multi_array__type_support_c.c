...
#include "example_interfaces/msg/detail/float32_multi_array__rosidl_typesupport_microxrcedds_c.h"
...
typedef example_interfaces__msg__Float32MultiArray _Float32MultiArray__ros_msg_type;
...
{
  bool full_bounded;
  return max_serialized_size_example_interfaces__msg__Float32MultiArray(&full_bounded, 0);
}
