...
#include "example_interfaces/msg/detail/u_int16_multi_array__rosidl_typesupport_microxrcedds_c.h"
...
typedef example_interfaces__msg__UInt16MultiArray _UInt16MultiArray__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _UInt16MultiArray__ros_msg_type * ros_message = (_UInt16MultiArray__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  // Member: data
  {
    ...
    rv = ucdr_serialize_sequence_uint16_t(cdr, ros_message->data.data, size);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: data
  {
    ...
    rv = ucdr_deserialize_sequence_uint16_t(cdr, ros_message->data.data, capacity, &size);
  ...
  size_t current_alignment)
{
  ...
  const _UInt16MultiArray__ros_msg_type * ros_message = (const _UInt16MultiArray__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
{
  bool full_bounded;
  return max_serialized_size_example_interfaces__msg__UInt16MultiArray(&full_bounded, 0);
}
