...
#include "example_interfaces/msg/detail/float32__rosidl_typesupport_microxrcedds_c.h"
...
typedef example_interfaces__msg__Float32 _Float32__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _Float32__ros_msg_type * ros_message = (_Float32__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;

  // Member: data
  rv = ucdr_serialize_float(cdr, ros_message->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: data
  rv = ucdr_deserialize_float(cdr, &ros_message->data);
  return rv;
}
  ...
  size_t current_alignment)
{
  ...
  const _Float32__ros_msg_type * ros_message = (const _Float32__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
static size_t _Float32__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_example_interfaces__msg__Float32(&full_bounded, 0);
}
