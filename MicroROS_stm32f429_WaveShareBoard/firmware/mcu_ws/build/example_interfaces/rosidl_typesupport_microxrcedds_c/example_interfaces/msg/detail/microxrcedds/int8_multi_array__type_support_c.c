...
#include "example_interfaces/msg/detail/int8_multi_array__rosidl_typesupport_microxrcedds_c.h"
...
typedef example_interfaces__msg__Int8MultiArray _Int8MultiArray__ros_msg_type;
...
{
  bool full_bounded;
  return max_serialized_size_example_interfaces__msg__Int8MultiArray(&full_bounded, 0);
}
