...
#include "geometry_msgs/msg/detail/wrench_stamped__rosidl_typesupport_microxrcedds_c.h"
...
typedef geometry_msgs__msg__WrenchStamped _WrenchStamped__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _WrenchStamped__ros_msg_type * ros_message = (_WrenchStamped__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  rv = ((const message_type_support_callbacks_t *)(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, geometry_msgs, msg, Wrench
      )()->data))->cdr_serialize(&ros_message->wrench, cdr);
  ...
  void * untyped_ros_message)
{
  ...
  rv = ((const message_type_support_callbacks_t *)(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, geometry_msgs, msg, Wrench
      )()->data))->cdr_deserialize(cdr, &ros_message->wrench);
  return rv;
}
  ...
  size_t current_alignment)
{
  ...
  const _WrenchStamped__ros_msg_type * ros_message = (const _WrenchStamped__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  // Member: wrench
  current_alignment +=
    get_serialized_size_geometry_msgs__msg__Wrench(&ros_message->wrench, current_alignment);
  ...
  size_t current_alignment)
{
  ...
  *full_bounded = true;
  ...
  // Member: wrench
  current_alignment +=
    max_serialized_size_geometry_msgs__msg__Wrench(full_bounded, current_alignment);

  return current_alignment - initial_alignment;
}

static size_t _WrenchStamped__max_serialized_size()
{
  bool full_bounded;
  return max_serialized_size_geometry_msgs__msg__WrenchStamped(&full_bounded, 0);
}
