...
#include "std_msgs/msg/detail/byte_multi_array__rosidl_typesupport_microxrcedds_c.h"
...
typedef std_msgs__msg__ByteMultiArray _ByteMultiArray__ros_msg_type;
...
{
  bool full_bounded;
  return max_serialized_size_std_msgs__msg__ByteMultiArray(&full_bounded, 0);
}
