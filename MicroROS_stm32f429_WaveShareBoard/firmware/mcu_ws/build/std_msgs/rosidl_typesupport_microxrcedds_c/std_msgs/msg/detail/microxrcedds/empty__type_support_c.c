...
#include "std_msgs/msg/detail/empty__rosidl_typesupport_microxrcedds_c.h"
...
typedef std_msgs__msg__Empty _Empty__ros_msg_type;
...
{
  bool full_bounded;
  return max_serialized_size_std_msgs__msg__Empty(&full_bounded, 0);
}
