...
#include "builtin_interfaces/msg/detail/duration__rosidl_typesupport_microxrcedds_c.h"
...
typedef builtin_interfaces__msg__Duration _Duration__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _Duration__ros_msg_type * ros_message = (_Duration__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _Duration__ros_msg_type * ros_message = (const _Duration__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
{
  bool full_bounded;
  return max_serialized_size_builtin_interfaces__msg__Duration(&full_bounded, 0);
}
